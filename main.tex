...
\makeglossaries \input{Glosario.tex} \renewcommand*{\glstextformat}[1]{\textbf{#1}}


\begin{document}

\input{Tesis/000_Portada}
\input{Tesis/00_Protocolo}  
...
\input{Tesis/01_Conceptual}
\input{Tesis/02_Contextual}
\input{Tesis/03_Analisis}
\input{Tesis/04_Metodologico}
\input{Tesis/05_Construccion}
\input{Tesis/06_Analisis}
\input{Tesis/07_Conclusion}

\printbibliography[heading=bibintoc,title={BIBLIOGRAFÍA Y WEBGRAFÍA}]
\addappheadtotoc 
\appendixpage 
\appendix  
\input{Tesis/08_Apendice}
\end{document}
